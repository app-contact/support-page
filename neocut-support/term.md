...
## 第1条（適用範囲）
本規約は、ユーザーと提供者の間における本アプリに関する一切に適用されます。

## 第2条（禁止事項）
ユーザーは以下の行為をしてはなりません：
- 法令・公序良俗に違反する行為
- 本アプリまたはサーバーの運営を妨害する行為
- 不正アクセス、改ざん、逆コンパイルなどの解析行為
- 無断での商用利用・転載・再配布
- その他、提供者が不適切と判断する行為

## 第3条（免責事項）
- 本アプリは情報の正確性・完全性を保証しません。  
- 利用によって生じた損害について、提供者は一切責任を負いません。  
- 本アプリは投資助言を目的としたものではありません。

## 第4条（サービスの変更・停止）
提供者はユーザーへの事前通知なしに、本アプリの内容を変更・停止できるものとします。

## 第5条（知的財産権）
本アプリに関する著作権・商標権・その他知的財産権は提供者または正当な権利者に帰属します。

## 第6条（準拠法・裁判管轄）
本規約は日本法を準拠法とし、紛争は提供者所在地を管轄する裁判所を専属的合意管轄とします。
