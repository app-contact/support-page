...
## 1. はじめに
NEOCUT（以下「本アプリ」）は、ユーザーのプライバシーを尊重し、関連する法令およびガイドラインを遵守して情報を適切に取り扱います。本プライバシーポリシーは、本アプリにおける情報の収集・利用・管理方法について説明するものです。
...
- **端末識別子（インストールID）**  
  アプリの利用管理および不正防止のために使用される識別子です。  
  直接個人を特定するものではありませんが、法令上は個人データとして扱われる場合があります。

- **アプリ利用状況**  
  Firebase Analytics を通じて、機能利用状況や操作傾向などの匿名化された統計情報を取得します。

- **クラッシュ情報**  
  Firebase Crashlytics を通じて、アプリの安定性向上および不具合調査を目的とした技術的情報を取得します。
...
- アプリの品質および安定性の向上
- 不具合の検出および修正
- 機能改善およびユーザー体験向上のための分析

## 4. 第三者提供・委託

本アプリは、取得した情報を以下の場合を除き、第三者に提供することはありません。

- Firebase（Google LLC）等の業務委託先に対し、上記利用目的の範囲内で提供する場合
- 法令に基づき開示が求められた場合

これらの委託先は、適切なセキュリティ管理措置を講じています。

## 5. データの管理および保存期間

取得した情報は、Firebase 等のクラウドサービスを利用して安全に管理されます。  
情報は利用目的の達成に必要な期間のみ保持され、不要になり次第、合理的な方法で削除されます。

## 6. 国外へのデータ転送

本アプリが利用するクラウドサービスのサーバーは、日本国外（主に米国等）に設置されている場合があります。  
そのため、取得した情報が国外で処理・保存されることがあります。
...
これらのご要望は、下記連絡先よりご連絡ください。  
また、本アプリをアンインストールすることで、端末内に保存されたデータは削除されます。

## 8. 子供のプライバシー

本アプリは13歳未満の児童を対象としておらず、意図的に13歳未満の児童から個人情報を収集することはありません。

## 9. サブスクリプションについて

- 購入は Apple ID アカウントに請求されます
- 現在の期間終了の24時間前までにキャンセルしない限り、サブスクリプションは自動更新されます
- サブスクリプションの管理およびキャンセルは、購入後に App Store のアカウント設定から行えます

## 10. お問い合わせ

プライバシーに関するご質問・ご要望は、以下のサポートページよりご連絡ください。
